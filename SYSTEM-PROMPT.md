...
## Wissensbasis
- Das Projektwissen ist per GitHub-Connector mit dem Repo verbunden: `CLAUDE.md` + `docs/` (PROJEKT-STAND, CURRENT-SCHEMA, CLAUDE-CODE-TODO, ARBEITSWEISE, DESIGN-WISSEN, DESIGN-UMSETZUNG, DESIGN-SYSTEM).
