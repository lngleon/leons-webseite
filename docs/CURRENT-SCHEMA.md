...
| Demo-Fotos (`/demo/restaurant`) | ✅ (27.08.2026) `restaurant-gastraum.webp` 868×1085 (4∶5, 61 KB, Hero), `restaurant-feuerstelle.webp` 1080×1080 (80 KB), `restaurant-teller.webp` 1080×1080 (130 KB), `restaurant-mittagslicht.webp` 1536×1024 (3∶2, 59 KB) – dazu die drei Über-uns-Fotos `restaurant-holzofen.webp` 1200×800 (48 KB), `restaurant-fleisch.webp` 819×1024 (4∶5, 70 KB), `restaurant-kueche.webp` 1200×800 (40 KB). Alle aus 1448×1086- bzw. 1536×1024-Quellen motivbezogen beschnitten und heruntergerechnet, **nie hochgerechnet** – der Hero erreicht dadurch im 768-px-Slot nur Faktor 1,13 bei DPR 1 | `public/demo/` |
| Demo-Fotos (`/demo/friseur`) | ✅ (27.08.2026) `friseur-salon.webp` 868×1085 (4∶5, 41 KB, Hero), `friseur-werkzeug.webp` 1080×1080 (121 KB), `friseur-waschplatz.webp` 1080×1080 (40 KB), `friseur-wartebank.webp` 1536×1024 (3∶2, 54 KB) – dazu `friseur-beratung.webp` 1200×800 (48 KB), `friseur-schnitt.webp` 868×1085 (4∶5, 38 KB), `friseur-spiegelwand.webp` 1200×800 (52 KB). **Die drei Team-Porträts (1∶1) fehlen weiterhin** und rendern als Platzhalter – dafür lagen keine Quellen vor | `public/demo/` |
